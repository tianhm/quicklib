...
class MainWindow(QtGui.QMainWindow):
    ...
    def initUi(self):
        """"""
        # 设置名称
        self.setWindowTitle(u'欢迎使用QucikLib')
    ...
    def updateInvestor(self, event):
        ...
        self.setWindowTitle(u'欢迎使用QuickLib框架Demo  ' + data['InvestorName'].decode('GBK'))
