...
int QUICKLIB_TD_API QryPosition(char *Instrument,int positiontype);    //自己增加
...
double QUICKLIB_TD_API QryAvailable();   //可用资金 自己增加





void QUICKLIB_TD_API SetShowPosition(bool showstate);   //可用资金 自己增加
...
//double QUICKLIB_TD_API QryAvailable2();   //可用资金 自己增加
#ifdef __cplusplus
}
#endif