...
public:
	...
	string    str_DN_Modol;
	string    str_DN_Serial;
	string    str_DN_ControllerRevision;
	string    str_HardDeskSize;
	string    str_HardDeskBufferSize;
	string    str_HardDeskType;
	string    str_HardDesk_Form;
	string    str_Controller;
};